...
module.exports = (function () {
  ...
  argv
    ...
    .option('--k8sContainerd', 'loads kuberntes containerd input-filter plugin')
    .option('--k8sEvents', 'reads Kubernetes Events from k8s API')
    .option('--dockerEvents', 'reads Docker Events from /var/run/docker.sock')
