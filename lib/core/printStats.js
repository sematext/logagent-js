...
StatsPrinter.prototype.printStats = function () {
  ...
  var logStats = {
    ...
    'parser.throughput.bps': Number((self.bytes / (duration / 1000)).toFixed(0)),
  ...
  consoleLogger.log('Logagent report: pid[' + process.pid + ']' + ' ' + duration + ' ms ' + this.count + ' lines parsed.  ' + throughput.toFixed(0) + ' lines/s ' + throughputMegaBytes.toFixed(3) + ' MB/s - empty lines: ' + this.emptyLines)
