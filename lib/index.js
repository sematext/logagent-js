  ...
  load: function (name, options) {
    try {
      ...
      if (this.cfg.globalTransform)
      {
        ...
        process.env.MAXMIND_DB_DIR = (process.env.MAXMIND_DB_DIR||this.cfg.MAXMIND_DB_DIR)
        geoip = require('maxmind')
        if (this.cfg.maxmindGeoIpFile && fs.existsSync(this.cfg.maxmindGeoIpFile)) {
          geoip.init(this.cfg.maxmindGeoIpFile)  
        }
