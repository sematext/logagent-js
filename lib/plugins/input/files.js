...
var eventEmitter = require('../../core/logEventEmitter')
...
InputFile.prototype.start = function () {
  ...
  if (globPattern) {
    ...
    logger.log('using glob pattern: ' + this.globPattern)
...
InputFile.prototype.tailFilesFromGlob = function (globPattern, scanTime) {
  if (globPattern) {
    glob(globPattern, {strict: false, silent: false}, function globCb (err, files) {
      if (!err) {
...
module.exports.plugin = InputFile
